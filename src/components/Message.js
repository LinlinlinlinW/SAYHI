...
class Message extends Component{
    ...
    styleControl = () => {
        if (this.props.haveRead === true) {
            return({
                ...this.state, boxShadow : "3px 3px 3px 3px gray"
            })
        } else{
            return ({
                ...this.state, boxShadow : "3px 3px 3px 3px #fbc8ec"
            })
        }
    }
    ...
    render(){
        return(
                <div className={"card-container"} style={this.styleControl()} onMouseEnter={this.mouseEnterCard} onMouseLeave={this.mouseLeaveCard}>
